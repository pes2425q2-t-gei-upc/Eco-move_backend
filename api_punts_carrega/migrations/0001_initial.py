...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='modelcotxe',
            name='tipus_carregador',
            field=models.ManyToManyField(related_name='tipus_carregador', to='api_punts_carrega.tipuscarregador'),
        ),
        migrations.CreateModel(
            name='Descomptes',
            fields=[
        ...
        migrations.AddField(
            model_name='datadescompte',
            name='usuari',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descomptes_obtinguts', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='reserva',
            name='estacion',
